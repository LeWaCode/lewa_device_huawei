...
PRODUCT_SPECIFIC_DEFINES += TARGET_PRELINKER_MAP=device/huawei/c8500/include/prelink-linux-arm.map
...
BOARD_EGL_CFG := device/huawei/c8500/egl.cfg
...
# Kernel
TARGET_PREBUILT_KERNEL := device/huawei/c8500/kernel
TARGET_PREBUILT_RECOVERY_KERNEL := device/huawei/c8500/recovery_kernel
...
PRODUCT_BUILD_PROP_OVERRIDES +=TARGET_BOOTLOADER_BOARD_NAME=c8500
TARGET_BOOTLOADER_BOARD_NAME := c8500

TARGET_CUSTOM_RELEASETOOL := device/huawei/c8500/tools/c8500update
