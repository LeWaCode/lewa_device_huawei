...
# for usb tethering,by george,2011-11-24
# TARGET_USE_CUSTOM_SECOND_LUN_NUM := 2
# for usb tethering,by ioz9,2012-03-14
...
#TARGET_CUSTOM_RELEASETOOL := device/huawei/c8650/tools/c8650update

# add by george,ref from u8800
#BOARD_HAS_JANKY_BACKBUFFER := true
#BOARD_RECOVERY_CHARGEMODE := true
#BOARD_RECOVERY_RMT_STORAGE := true
#TARGET_RECOVERY_INITRC := device/huawei/c8650/recovery.rc
